const Others = () => {
    return (
        <section id="certification" className="mb-16 scroll-mt-16 md:mb-24 lg:mb-36 lg:scroll-mt-24" aria-label="Certifications">
                ...
                <ol className="group/list">
                    ...
                    <li className="mb-12">
                        <div className="group relative grid pb-1 transition-all sm:grid-cols-8 sm:gap-8 md:gap-4">
                            ...
                            <div className="z-10 sm:col-span-6">
                                <h3 className="font-medium leading-snug">ISTQB Advanced Level (ISTQB)</h3>
                                <ul className="mt-2 flex flex-wrap" aria-label="Related links">
                                    <li className="mr-4">
                                        <a
                                            className="relative mt-2 inline-flex items-center text-sm font-medium text-slate-800 hover:text-blue-500 focus-visible:text-blue-500 dark:text-slate-300 dark:hover:text-teal-300 dark:focus-visible:text-teal-300"
                    ...
                    <li className="mb-12">
                        <div className="group relative grid pb-1 transition-all sm:grid-cols-8 sm:gap-8 md:gap-4">
                            ...
                            <div className="z-10 sm:col-span-6">
                                <h3 className="font-medium leading-snug">SQL 개발자 자격증 (한국데이터산업진흥원)</h3>
                                <ul className="mt-2 flex flex-wrap" aria-label="Related links">
                                    <li className="mr-4">
                                        <a
                                            className="relative mt-2 inline-flex items-center text-sm font-medium text-slate-800 hover:text-blue-500 focus-visible:text-blue-500 dark:text-slate-300 dark:hover:text-teal-300 dark:focus-visible:text-teal-300"
